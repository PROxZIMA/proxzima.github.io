...
#
# Found a bug? Report it here: https://github.com/PROxZIMA/proxzima.github.io/issues

set -e -u

eval "git clone 'https://github.com/PROxZIMA/proxzima.github.io.git' LiveTerm"
